...
const filePath = __dirname + "/../src/modules/" + moduleName.trim();
try {
  ...
  if (!fs.existsSync(filePath + "/migrations"))
    fs.mkdirSync(filePath + "/migrations");
  fs.copyFileSync(
    __dirname + "/../src/templates/migration-template.ts",
